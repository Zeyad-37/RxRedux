...
public final class SnackBarFactory {
    ...
    public static Snackbar getSnackBar(String snackBarType, @NonNull View view, @StringRes int stringId,
            int duration) {
        return getSnackBar(view, stringId, duration, getColorId(snackBarType));
    }

    public static Snackbar getSnackBar(String snackBarType, @NonNull View view, @NonNull CharSequence text,
            int duration) {
    ...
    public static Snackbar getSnackBarWithAction(String snackBarType, @NonNull View view,
            @NonNull CharSequence text, String actionText, View.OnClickListener onClickListener) {
