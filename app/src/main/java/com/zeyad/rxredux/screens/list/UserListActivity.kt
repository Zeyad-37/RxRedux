...
//        eventObservable = eventObservable.mergeWith(usersAdapter.itemClickObservable
//                .map {
//                    if (it.itemInfo.getData<Any>() is User)
//                    UserClickedEvent(it.itemInfo.getData(), it.holder as UserViewHolder)
